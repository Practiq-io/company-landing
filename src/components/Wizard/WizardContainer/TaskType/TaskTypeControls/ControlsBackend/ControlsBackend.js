        ...
        return (
            ...
            <div className="card-set">
                ...
                >
                    ...
                    <div 
                        style = {{
                            background: taskType === "General purpose API" ? '#1371FC' : "white",
                            border: taskType === "General purpose API" ? "1px solid transparent" : "1px solid #E9E9ED"
                        }}
                    ...
                    >
                        ...
                        <img 
                            style = {{
                                display: taskType === "General purpose API" ? "block" : "none"
                            }}
                            src={selectDot} 
                            alt="" 
                ...
                >
                    ...
                    <div 
                        style = {{
                            background: taskType === "API Connector/Adapter" ? '#1371FC' : "white",
                            border: taskType === "API Connector/Adapter" ? "1px solid transparent" : "1px solid #E9E9ED"
                        }}
                        className="task-type_card--select-circle"
                    >
                        ...
                        <img 
                            style = {{
                                display: taskType === "API Connector/Adapter" ? "block" : "none"
                            }}
                            src={selectDot} 
                            alt="" 
            ...
            <div className="card-set">
                ...
                >
                    ...
                    <div 
                        style = {{
                            background: taskType === "Long running process" ? '#1371FC' : "white",
                            border: taskType === "Long running process" ? "1px solid transparent" : "1px solid #E9E9ED"
                        }}
                        className="task-type_card--select-circle"
                    >
                        ...
                        <img 
                            style = {{
                                display: taskType === "Long running process" ? "block" : "none"
                            }}
                            src={selectDot} 
                            alt="" 
                ...
                >
                    ...
                    <div 
                        style = {{
                            background: taskType === "Landing page / SPA / Component" ? '#1371FC' : "white",
                            border: taskType === "Landing page / SPA / Component" ? "1px solid transparent" : "1px solid #E9E9ED"
                        }}
                        className="task-type_card--select-circle"
                    >
                        ...
                        <img 
                            style = {{
                                display: taskType === "Landing page / SPA / Component" ? "block" : "none"
                            }}
                            src={selectDot} 
                            alt="" 
            ...
            >
                    ...
                    <div 
                        style = {{
                            background: taskType === "Custom backend task" ? '#1371FC' : "white",
                            border: taskType === "Custom backend task" ? "1px solid transparent" : "1px solid #E9E9ED"
                        }}
                        className="task-type_card--select-circle"
                    >
